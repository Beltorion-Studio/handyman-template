...
featured: false
author: 'Handyman Pro'
heroImage: '@assets/images/bedroom-with-wallpaper.jpg'
...
<ProTipCard
  id="pro-tip-diy"
  title="Pro Tip"
  description="Smart homeowners know that the cheapest option isn't always DIY, and the most expensive isn't always hiring a pro. The key is matching the project complexity to your skills, available time, and risk tolerance."
/>
